...
? target == atmega128 {
    ...
    const %PORTF: u8 = 0x0062

    const %PING: u16  = 0x0063
    const %DDRG: u16  = 0x0064
    const %PORTG: u8 = 0x0065
...
? target == atmega3250 {
    ...
    const %PORTH: u8 = 0x00DA

    const %PINJ: u16  = 0x00DB
    const %DDRJ: u16  = 0x00DC
    const %PORTJ: u8 = 0x00DD
...
? target == attiny10 {
    const %PINB: u16  = 0x0000
    const %DDRB: u16  = 0x0001
    const %PORTB: u8 = 0x0002

}

? target == attiny20 {
    const %PINA: u16  = 0x0000
    const %DDRA: u16  = 0x0001
    const %PORTA: u8 = 0x0002

    const %PINB: u16  = 0x0004
    const %DDRB: u16  = 0x0005
    const %PORTB: u8 = 0x0006
...
? target == attiny40 {
    ...
    const %PINC: u16  = 0x001B
    const %DDRC: u16  = 0x001C
    const %PORTC: u8 = 0x001D
...
? target == atxmega128b1 {
    ...
    const %PORTG: u8 = 0x06C4

    const %PINM: u16  = 0x0768
    const %DDRM: u16  = 0x0760
    const %PORTM: u8 = 0x0764
