...
? target == at43usb320 {
    const %WDT_CTRL_REG: u8 = 0x0041
    const WDT_IS_MODERN: u16 = 0x0000
    const %WDT_STATUS_REG: u8 = 0x0000
}
...
? target == at76c711 {
    const %WDT_CTRL_REG: u8 = 0x0041
    const WDT_IS_MODERN: u16 = 0x0000
    const %WDT_STATUS_REG: u8 = 0x0054
}

? target == at86rf401 {
    const %WDT_CTRL_REG: u8 = 0x0042
    const WDT_IS_MODERN: u16 = 0x0000
    const %WDT_STATUS_REG: u8 = 0x0000
}

? target == at90c8534 {
    const %WDT_CTRL_REG: u8 = 0x0000
    const WDT_IS_MODERN: u16 = 0x0000
    const %WDT_STATUS_REG: u8 = 0x0000
}

? target == at90can128 {
    const %WDT_CTRL_REG: u8 = 0x0060
    const WDT_IS_MODERN: u16 = 0x0000
    const %WDT_STATUS_REG: u8 = 0x0054
}
...
? target == ata5702m322 {
    const %WDT_CTRL_REG: u8 = 0x006E
    const WDT_IS_MODERN: u16 = 0x0000
    const %WDT_STATUS_REG: u8 = 0x004B
}
...
? target == atmega1608 {
    const %WDT_CTRL_REG: u8 = 0x0100
    const WDT_IS_MODERN: u16 = 0x0001
    const %WDT_STATUS_REG: u8 = 0x0101
}
...
? target == attiny1634 {
    const %WDT_CTRL_REG: u8 = 0x0050
    const WDT_IS_MODERN: u16 = 0x0000
    const %WDT_STATUS_REG: u8 = 0x0055
}
